...
public class DraftScreen {
	...
	private void initialize() {
		...
		JLabel txtDraftWelcome = new JLabel();
		txtDraftWelcome.setHorizontalAlignment(SwingConstants.CENTER);
		txtDraftWelcome.setBackground(new Color(255, 255, 255));
		txtDraftWelcome.setOpaque(true);
